...
output_path = Path("/ghome/c5mcv07/C5_G7_MCV/Week_2/faster-rcnn/output/finetuned_inference")
...
for split in ["train", "test"]:
    ...
    DatasetCatalog.register(f"kitti_mots_{split}", lambda: build_kitti_mots_dicts(str(dataset_path), instances_ids=instances_ids))
