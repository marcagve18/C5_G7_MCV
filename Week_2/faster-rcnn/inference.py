...
output_path = Path("/ghome/c5mcv07/C5_G7_MCV/Week_2/faster-rcnn/output/pretrained_inference")
...
DatasetCatalog.register("kitti_mots", lambda: build_kitti_mots_dicts(str(dataset_path), instances_ids=INSTANCES_IDS))

dataset_dicts = build_kitti_mots_dicts(str(dataset_path), instances_ids=INSTANCES_IDS)
